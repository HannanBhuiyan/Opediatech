                ...
                <ul>
                    ...
                    {{-- <li>
                        <div class="menu_inner_item">
                            ...
                            <div class="menu_link">
                                <a href="{{ route('agency.index') }}">Agency Story</a>
                            </div>
                        </div>
                    </li> --}}
                    <li>
                    ...
                    <li>
                        {{-- <div class="menu_inner_item">
                            <div class="menu_icon_image">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/menu/blog.png" alt="icon">
                            </div>
                            <div class="menu_link">
                                <a href="{{ route('blogpage.index') }}">Blog</a>
                            </div>
                        </div> --}}
                    </li>
                     <li>
