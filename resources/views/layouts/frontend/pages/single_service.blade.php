@include('layouts.frontend.inc.header',[$seo_title=$category->seo_title ?? '', $seo_description = $category->seo_description ?? ''])
    ...
    <div class="banner__section">
        ...
        <div class="container">
            <div class="banner__footer">
                <div class="list">
                    <a href="{{ route('index') }}">Home</a> <span>/</span> <a href="{{ route('servicepage.index') }}">Service</a> <span>/</span> <span class="coloradd"> {{ $category->category_fname ??'' }} {{ $category->category_lname ??''}}</span>
                </div>
            </div>
        </div>
    </div>
   ...
   @if ( $loop->index % 2 == 0)
    <div class="web__design" style="background-color:{{ $ser->color_code }}">
        <div class="container">
            <div class="web__inner">
                ...
                <div class="dive__quate">
                    <a class="service__page" href="#"> <span>Se</span>e More <i class="fa-solid fa-arrow-right"></i></a>
   ...
   @endif
    ...
    <div class="container-cos">
        <div class="service-blog-1">
            <h3>{{ $single_service_details->main_title }}</h3>
            <div class="text-end">
                <p>{!! $single_service_details->main_title_desc !!}</p>
            </div>
        </div>
        <div class="service-blog-2">
            <h2>{{ $single_service_details->blog_title }}</h2>
            <div class="row row-ser">
                <div class="col-12 col-lg-5 col-md-5 col-sm-12">
                    <img class="service-blog-img" src="https://opedia.mo.cloudinary.net/opediatech_dynamic/{{$single_service_details->image}}" alt="image" srcset="">
                </div>
