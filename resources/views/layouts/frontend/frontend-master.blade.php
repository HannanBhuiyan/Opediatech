            ...
            <div class="container">
                <div class="hero__inner">
                    <div class="row align-items-center">
                        ...
                        {{-- <div class="col-md-5">
                            <div class="giffy">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/hero/hero1.gif" alt="agency">
                            </div>
                        </div> --}}
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6">
                    <div class="mission_slider">
                        <img src="{{ asset('frontend') }}/assets/images/vission.png" alt="vission_img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="swiper myTeamSwiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide project_item"> 
                <a href="#">
                    <img width="100%" src="{{ asset('frontend') }}/assets/images/project/image_one.png" alt="img">
                    <div class="project_overlay"> 
                        <h4 class="project-title">Jenfi – Financial Website</h4>
                    </div>
                </a>
              </div>
              <div class="swiper-slide project_item"> 
                <a href="#">
                    <img width="100%" src="{{ asset('frontend') }}/assets/images/project/image_two.png" alt="img">
                    <div class="project_overlay"> 
                        <h4 class="project-title">Jenfi – Financial Website</h4>
                    </div>
                </a>
              ...
              <div class="swiper-slide project_item">
                <a href="#">
                    <img width="100%" src="{{ asset('frontend') }}/assets/images/project/image_three.png" alt="img">
                    <div class="project_overlay"> 
                        <h4 class="project-title">Jenfi – Financial Website</h4>
                    </div>
                </a>
              ...
              <div class="swiper-slide project_item"> 
                <a href="#">
                    <img width="100%" src="{{ asset('frontend') }}/assets/images/project/image_four.png" alt="img">
                    <div class="project_overlay"> 
                        <h4 class="project-title">Jenfi – Financial Website</h4>
                    </div>
                </a>
              ...
              <div class="swiper-slide project_item"> 
                <a href="#">
                    <img width="100%" src="{{ asset('frontend') }}/assets/images/project/image_five.png" alt="img">
                    <div class="project_overlay"> 
                        <h4 class="project-title">Jenfi – Financial Website</h4>
                    </div>
                </a>
              ...
              <div class="swiper-slide project_item">
                <a href="#">
                    <img width="100%" src="{{ asset('frontend') }}/assets/images/project/image_six.png" alt="img">
                    <div class="project_overlay"> 
                        <h4 class="project-title">Jenfi – Financial Website</h4>
                    </div>
                </a>
              ...
              <div class="swiper-slide project_item"> 
                <a href="#">
                    <img width="100%" src="{{ asset('frontend') }}/assets/images/project/image_seven.png" alt="img">
                    <div class="project_overlay"> 
                        <h4 class="project-title">Jenfi – Financial Website</h4>
                    </div>
                </a>
              ...
              <div class="swiper-slide project_item">
                <a href="#">
                    <img width="100%" src="{{ asset('frontend') }}/assets/images/project/image_eight.png" alt="img">
                    <div class="project_overlay"> 
                        <h4 class="project-title">Jenfi – Financial Website</h4>
                    </div>
                </a>
              ...
              <div class="swiper-slide project_item"> 
                <a href="#">
                    <img width="100%" src="{{ asset('frontend') }}/assets/images/project/image_nine.png" alt="img">
                    <div class="project_overlay"> 
                        <h4 class="project-title">Jenfi – Financial Website</h4>
                    </div>
                </a>
        ...
        <div class="container">
                    ...
                    <div class="logo__area">
                        <div class="client_logo_item">
                            <div class="logo__section">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/00.png" alt="image">
                            </div>
                        </div>
                        <div class="client_logo_item">
                            <div class="logo__section">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/06.png" alt="image">
                            </div>
                        </div>
                        <div class="client_logo_item">
                            <div class="logo__section">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/07.png" alt="image">
                            </div>
                        </div>
                        <div class="client_logo_item">
                            <div class="logo__section">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/08.png" alt="image">
                            </div>
                        </div>
                    </div>
                    <div class="logo__area">
                        <div class="client_logo_item">
                            <div class="logo__section">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/3.png" alt="image">
                            </div>
                        </div>
                        <div class="client_logo_item">
                            <div class="logo__section">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/1.png" alt="image">
                            </div>
                        </div>
                        <div class="client_logo_item">
                            <div class="logo__section">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/2.png" alt="image">
                            </div>
                        </div>
                        <div class="client_logo_item">
                            <div class="logo__section">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/09.png" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="client__satisfic">
                <div class="row gx-xl-5  align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="giffy">
                            <img width="100%" loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/testmonial/03.jpg" alt="image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="partners__tab">
                    <div class="title text-center">
                        ...
                        <div class="affiliates__tab">
                            <div class="images">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/basis.png" alt="image">
                                <img class="mb-4"  loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/out_affiliates3.png" alt="image">
                                <img class="mb-4"  loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/icon/out_affiliates1.png" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper boss__swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <div class="image__section">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/testmonial/Test1.png" alt="image">
                            </div>
                        </div>
                        <div class="col-md-7">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <div class="image__section">
                                <img loading="lazy" src="https://opedia.mo.cloudinary.net/opediatech_images/testmonial/Test2.png" alt="image">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="boss__spec">
